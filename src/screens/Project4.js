...
import featuresLottie01 from "../assets/lottie/Features_001.json";
import featuresLottie02 from "../assets/lottie/Features_002.json";
import implimentLottie from "../assets/lottie/Implimentation.json";
import objectiveLottie from "../assets/lottie/Objective_Lottie.json";
import outcomeLottie from "../assets/lottie/Outcome.json";
  ...
  return (
    <>
      <div className="w-full h-full overflow-hidden">
          ...
          >
            ...
            >
              ...
              <div className="w-full h-full flex flex-col gap-2 justify-end items-center">
                ...
                <h1
                  className="text-2xl md:text-5xl text-gray-300 font-bold capitalize text-center"
                  data-aos="fade-left"
                >
        ...
        <div className="w-full h-auto py-20 px-5 lgl:px-20 flex flex-col gap-20 lg:gap-24">
          ...
          {/* OBJECTIVES */}
          <div className="w-full flex flex-col lgl:flex-row gap-10 lgl:gap-0 lgl:justify-between items-center">
            <div className="w-full lgl:w-[40%] flex flex-col lgl:flex-col-reverse gap-10 lgl:gap-3">
              <div className="flex justify-center items-center">
                <Lottie animationData={objectiveLottie} />
              </div>
              <div className="flex flex-col gap-1 justify-center items-center">
                <div>
                  <div className=" text-3xl md:text-5xl" data-aos="fade-right">
                    Objectives
                  </div>
                  <div
                    className="w-[40%] h-[5px] bg-designColor"
                    data-aos="fade-left"
                  ></div>
                </div>
              </div>
            </div>
            <div className="w-full lgl:w-[55%] flex">
              <p className="text-md text-bold font-light text-lightText tracking-wide">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-row gap-4" data-aos="fade-left">
                    ...
                    <div>
                      <span className="text-white">Enhance Test Coverage:</span>{" "}
                  ...
                  <div className="flex flex-row gap-4" data-aos="fade-right">
                    ...
                    <div>
                      <span className="text-white">Maintain High Quality:</span>{" "}
                      Ensure the application meets high standards of quality and
          ...
          <div className="flex flex-col gap-10">
            <div className="w-full flex justify-center">
              <div className="flex flex-col gap-1">
                <div className="text-3xl md:text-5xl" data-aos="fade-left">
                  Test Scenarios
                </div>
                <div
                  className="w-[40%] h-[5px] bg-designColor"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lgl:grid-cols-3 gap-3">
              <div
                className="flex flex-row gap-1 bg-cardColor hover:bg-cardColorHover px-5 py-5 rounded"
                data-aos="fade-right"
              >
                <div className="text-designColor pt-0.5">
                  <MdDoubleArrow />
                </div>
                <div className="text-sm flex flex-col gap-1">
                  ...
                  messages for invalid or incomplete information, as well as
                  checking the email verification process. For user login, tests
                  will confirm successful login with valid credentials, validate
                  error messages for incorrect usernames or passwords, and test
              ...
              >
                ...
                <div className="text-sm flex flex-col gap-1">
                  ...
                  Dashboard navigation scenarios will ensure the correct loading
                  of the user dashboard after login, verify navigation to
                  different sections like profile, courses, and settings, and
                  check for the correct display of user-specific information and
                  notifications. Course enrollment tests will verify successful
                  enrollment in a course, proper handling of prerequisites and
              ...
              >
                ...
                <div className="text-sm flex flex-col gap-1">
                  ...
                  For course checkout, scenarios include validating the course
                  selection process and addition to the shopping cart,
                  confirming the accuracy of course prices, discounts, and total
                  amounts, and verifying the functionality of promotional codes
                  and vouchers. Payment gateway integration will ensure
                  successful processing of payments using various methods,
                  validate error handling for failed transactions, and check the
                  security and encryption of payment data.
                </div>
              </div>
              <div
                className="flex flex-row gap-1 bg-cardColor hover:bg-cardColorHover px-5 py-5 rounded"
              ...
              >
                ...
                <div className="text-sm flex flex-col gap-1">
                  <span className="text-md text-white">User Logout:</span>{" "}
                  Logout process scenarios will verify successful logout from
                  the portal, ensure redirection to the login page post-logout,
                  and confirm that no user-specific data is accessible after
                  logout. User profile management tests will verify updating
                  profile information, check for accurate reflection of changes
                  across the portal, and validate error messages for invalid
                  input data.
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="text-sm flex flex-col gap-1">
                  ...
                  The payment scenario for the LearnIt360 online course portal
                  involves several key steps to ensure the payment process is
                  smooth, secure, and user-friendly. Initially, the scenario
                  verifies that users can successfully add courses to their
                  shopping cart and proceed to checkout. It checks that the
                  course prices, discounts, and total amounts are accurately
                  displayed, and that any promotional codes or vouchers applied
              ...
              >
                ...
                <div className="text-sm flex flex-col gap-1">
                  ...
                  Search functionality scenarios will verify the accuracy and
                  relevance of search results for courses, test search filters
                  and sorting options, and ensure correct handling of no results
                  found scenarios. Finally, accessibility and usability tests
                  will check for compatibility with different browsers and
                  devices, validate accessibility features, and ensure a
          ...
          <div className="flex flex-col gap-3 lgl:gap-10">
            <div className="flex flex-col-reverse lgl:flex-row gap-10 lgl:gap-0 lgl:justify-between items-center">
              ...
              <div className="w-full lgl:w-[30%]">
                <div className="flex flex-col gap-10 lgl:gap-3 justify-center items-center">
                  <div>
                    <Lottie animationData={featuresLottie01} />
                  </div>
                  <div className="flex flex-col gap-1">
                    <div className="text-3xl md:text-5xl" data-aos="fade-left">
                      Key Features
            ...
            <div className="flex flex-col-reverse gap-10 lgl:gap-0 lgl:flex-row justify-between items-center">
              <div className="w-full lgl:w-[35%]">
                <div>
                  <Lottie animationData={featuresLottie02} />
                </div>
              </div>
              <div className="w-full lgl:w-[60%]">
                <p className="text-md text-bold font-light text-lightText tracking-wide">
          ...
          <div className="w-full flex flex-col gap-10">
            ...
            >
              <div>
                ...
                <div
                  className="w-[30%] h-[5px] bg-designColor"
                  data-aos="fade-right"
                ></div>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col-reverse lgl:flex-row gap-10 lgl:gap-0 lgl:justify-between lgl:items-end">
            <div className="w-full lgl:w-[55%] flex">
              <p className="text-md text-bold font-light text-lightText tracking-wide">
                <div className="flex flex-col gap-3">
                  <div className="flex flex-row gap-4" data-aos="fade-right">
                  ...
                  <div className="flex flex-row gap-4" data-aos="fade-right">
                    ...
                    <div>
                      <span className="text-white">TestNG Configuration:</span>{" "}
                  ...
                  <div className="flex flex-row gap-4" data-aos="fade-left">
                    ...
                    <div>
                      ...
                      Configure reporting tools like Allure or ExtentReports to
            ...
            <div className="w-full lgl:w-[40%] flex flex-col lgl:flex-col gap-10 lgl:gap-0">
              <div className="flex justify-center items-center">
                <Lottie animationData={implimentLottie} />
              </div>
              <div className="flex flex-col gap-1 justify-center items-center">
                <div>
                  <div className=" text-3xl md:text-5xl" data-aos="fade-left">
          ...
          <div className="w-full flex flex-col lgl:flex-row gap-10 lgl:gap-0 lgl:justify-between lgl:items-end">
            <div className="w-full lgl:w-[40%] flex flex-col lgl:flex-col gap-10 lgl:gap-0">
              <div className="flex justify-center items-center">
                <Lottie animationData={outcomeLottie} />
              </div>
              <div className="flex flex-col gap-1 justify-center items-center">
                <div>
                  <div className=" text-3xl md:text-5xl" data-aos="fade-left">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-row gap-4" data-aos="fade-right">
                    ...
                    <div>
                      ...
                      through automated testing integrated into the development
                      pipeline.
                    </div>
                  </div>
                </div>
