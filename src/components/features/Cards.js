...
export default function Cards(props) {
  return (
    <div className="w-full px-5 h-60 py-5 rounded-lg shadow-shadowOne flex items-center bg-gradient-to-r from-bodyColor to-[#232027] group hover:bg-gradient-to-b hover:from-black hover:to-black transition-colors duration-100">
