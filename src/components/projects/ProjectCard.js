...
export default function ProjectCard(props) {
  return (
    <>
      <div
        className="w-full px-5 py-5 rounded-lg flex flex-col shadow shadow-designColor bg-cardColor hover:bg-cardColorHover hover:bg-gradient-to-b transition-colors duration-500 group"
        data-aos="zoom-in"
        data-aos-offset="100"
      >
