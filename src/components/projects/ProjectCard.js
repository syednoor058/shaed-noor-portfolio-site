...
export default function ProjectCard(props) {
  return (
    <div className='w-full px-5 py-5 rounded-lg flex flex-col bg-cardColor hover:bg-cardColorHover group hover:bg-gradient-to-b transition-colors duration-500' data-aos="zoom-in" data-aos-offset="200">
        ...
        <div className='w-full mt-5 flex justify-between items-center gap-5'>
            <div>
            <Link to={props.forwordUrl}><h3 className='text-sm md:text-base uppercase text-designColor font-normal'>{props.title}</h3></Link>
            </div>
            <div>
