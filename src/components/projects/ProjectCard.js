...
export default function ProjectCard(props) {
  return (
    <div className='w-full px-5 py-5 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-black hover:to-black transition-colors duration-500'>
