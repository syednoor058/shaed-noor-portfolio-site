  ...
  return (
    <section id="projects" className="w-full py-10 lg:py-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 xl:gap-10">
        ...
        <ProjectCard forwordUrl="/e-learning-app-automation-test-details" title="E-Learning Application Automation Test (Selenium & TestNG)" desc="This repository contains Selenium-based automated tests for the LearnIt360 online course portal using Java. It includes tests for user authentication, course enrollment, content access, course checkout, payment gateway, and profile management. Technologies used: Selenium WebDriver, TestNG, Maven, and ExtentReports." coverSrc={projectFiveCover} githubLink="https://github.com/syednoor058/LearnIT360-Selenium-Automation-Testing-Project.git" />
